...
SQL> SELECT EMP.*, SAL*12+2000 AS ANNUSL_BONUS
  2  FROM EMP;

     EMPNO ENAME      JOB              MGR HIREDATE         SAL       COMM     DEPTNO ANNUSL_BONUS
---------- ---------- --------- ---------- --------- ---------- ---------- ---------- ------------
...
SQL> SELECT ENAME, SAL, SAL+ SAL*100/100 "HIKE OF 10%"
  2  FROM EMP;
...
SQL> SELECT ENAME, SAL, SAL*12 "ANNUAL SAL", (SAL*12) -SAL*10/100 "ANNUAL - 10%"
  2  FROM EMP;

ENAME             SAL ANNUAL SAL ANNUAL - 10%
---------- ---------- ---------- ------------
SMITH             800       9600         9520
ALLEN            1600      19200        19040
WARD             1250      15000        14875
JONES            2975      35700      35402.5
MARTIN           1250      15000        14875
BLAKE            2850      34200        33915
CLARK            2450      29400        29155
SCOTT            3000      36000        35700
KING             5000      60000        59500
TURNER           1500      18000        17850
ADAMS            1100      13200        13090
JAMES             950      11400        11305
FORD             3000      36000        35700
MILLER           1300      15600        15470
